...
<head>
	...
	<title>Product -Self share</title>
	<link rel="icon" href="logo copy.png" type="image/icon type">
...
<body>
	...
	<header>
		...
		<a onclick="popup()"><button id="login">Login</button></a>
		<a href="register.php"><button id="register">Register</button></a>
	</header>
	<aside>
		<img src="shekhar.jpg" height="75px" width="75px">
		<h1>&#8377;<span id="price">850</span></h1>
		<span>+&#8377;<span id="extra">700</span> per extra day</span>
		<hr width="95%">
		<h2>Shekhar</h2>
		Member since 2015<br>
		Usually responds within few hours<br>
		19 share<br>Verified product<br>
		<button onclick="show('rentcont')">Consultation and rent</button>
	</aside>

	<footer>
		<img src="shekhar.jpg" height="50px" width="50px">
		<span id="user"><b>Shekhar</b></span>
		<button onclick="show('rentcont')">Consultation and rent</button>
	</footer>
	<div id="mainproduct">
		...
		<h2>Classic Bullet on rent</h2>
		<span id="showprice">
			<h1>&#8377;<span id="price">850</span></h1>
			<span>+&#8377;<span id="extra">700</span> per extra day</span>
		</span>
		<p>A black classic royal enfield is on rent. Its 2015 model bike maintained properly. Service should be done just before pickup for best performance. For further information check additional information.  
		</p><p><fieldset>
			Secirity deposit : 1. Valid original Driving License should be present with the rider.<br>
            &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp; 2. Original ID proof (Passport, Voters ID or Aadhaar Card) needs to be &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;submitted at the time of picking up the vehicle.<br><br>
            Kilometer limit: 1. There is no extra charge for 250kms/day. Additional kms would be charged  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;  at Rs 5/km. <br>
             &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;2. Fuel is not included<br>
             &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;3. Operational hours 7AM to 10 PM
		</fieldset> </p><br><br>
